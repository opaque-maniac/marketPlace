  ...
  return (
    <Transition>
      ...
      <main role="main" className="h-full pt-20 relative md:pb-0 pb-6">
        ...
        <div className="flex justify-center items-center xl:flex-row flex-col xl:gap-4 gap-6">
          <div className="shadow-xl border rounded-lg md:w-auto w-80 md:mx-0 mx-auto px-2 py-2">
            <div className="">
          ...
          <div className="lg:w-600 md:w-500 shadow-xl border rounded-lg xl:pt-0 pt-2">
            <ContactForm />
          </div>
        </div>
      </main>

    ...
    <Transition>
      <main role="main" className="h-full pt-20 relative">
        <p className="absolute top-4 left-4">
          {" "}
          Home / <span className="font-extrabold">Reset Confirmation</span>
        </p>

        <section className="md:w-8/12 w-full lg:mx-auto">
          <div className="pb-8 md:pl-0 pl-4">
            <h2 className="text-2xl font-bold">Reset Profile Password</h2>
            ...
            <p>
              The link will redirect you to a page where you can change your
              password
            </p>

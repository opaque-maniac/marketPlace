...
const EmailChangeButton = lazy(() => import("./button"));
...
export default function ChangeEmailRequestPage() {
  ...
  return (
    <Transition>
      <main role="main" className="relative pt-14">
        ...
        <div>
          <h3 className="text-2xl font-semibold text-center">Change Email</h3>
        </div>
        {isLoading ? (
          <div
          ...
          <div>
            <section>
              <div className="xl:w-6/12 md:w-8/12 mx-auto text-center">
                <p>
                  To change the email address currently on this profile, an
                  email with a link will be sent to the email address that is

...
const CartItemComponent = ({ cartItem, refetch }: Props) => {
  return (
    <div className="flex md:flex-row flex-col md:justify-evenly justify-center items-center gap-4 border border-black/25 pl-1 md:w-500 w-[250px] md:h-180 h-auto md:pb-0 pb-4">
      <div>
        <img

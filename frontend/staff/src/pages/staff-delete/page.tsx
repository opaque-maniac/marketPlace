...
export default function StaffDeletePage() {
  const { id } = useParams();
        ...
        {isLoading || !staff ? (
          ...
          <div className="h-full w-full flex justify-start xl:justify-center items-center md:items-start xl:flex-row flex-col gap-4 pt-4">
            ...
            <section className="md:w-5/12">
              ...
              <div>
                <p>
                  Are your sure you want to delete the profile of this staff, if
                  you are, you need to make sure you file a misconduct log for
                  the user. If none exists then you will not be able to proceed.
                  Click{" "}
                  <Link
                    to={"/new-misconduct"}
